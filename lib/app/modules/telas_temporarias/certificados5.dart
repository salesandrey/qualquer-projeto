import 'package:PadrinhoMED/app/modules/telas_temporarias/certificados2.dart';
import 'package:PadrinhoMED/app/styles/constants.dart';
import 'package:flutter/material.dart';

class P2MeusCertificados5 extends StatefulWidget {
  static String id = "P2MeusCertificados5";

  @override
  _P2MeusCertificados5State createState() => _P2MeusCertificados5State();
}

class _P2MeusCertificados5State extends State<P2MeusCertificados5> {
  bool off = false;
    ...
    return GestureDetector(
      onTap: () {
        Navigator.of(context).push(
            new MaterialPageRoute(builder: (context)=>P2MeusCertificados2(),)
        );
      },
      child: Container(
